...
q-layout(padding)
  ...
  q-footer
    ...
    .row.q-pa-md.bg-grey-9
      .col
        .row.justify-center
          q-btn(color="cyan-8" flat href="https://stats.boid.com/d/X2YaUPRnk/eospowerup?orgId=1&from=now-7d&to=now&kiosk=tv" size="md" target="_blank" type="a") Resources stats
